...
For the list of supported platforms (and instructions on how to get started), click `here <https://docs.luxonis.com/projects/api/en/latest/install/#other-installation-methods>`__.
