...
The DepthAI OAK-D WiFi (BW1098OBC_WiFi) is a modified version of the OAK-D with an added WiFi module. This board allows users to quickly prototype standalone embedded 
solutions.

Besides the standard DepthAI capabilites, the OAK-D WiFi gives users access to a lightweight processor with useful features such as Bluetooth, Bluetooth 
