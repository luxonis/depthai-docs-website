...
we can use `blobconverter app <http://blobconverter.luxonis.com>`__ to convert it to ``.blob``. I will be using the latest
...
We now have our normalized model in IR. I will use `blobconverter app <blobconverter.luxonis.com>`__ to convert it to ``.blob``, which is required
by the DepthAI.
