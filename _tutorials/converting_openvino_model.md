---
layout: default
title: Tutorial - How Convert OpenVINO IR Model to Run on DepthAI
...
This tutorial has the same dependencies as the [Hello World Tutorial](/tutorials/hello_world#dependencies) with one addition: OpenVINO version `2020.1`. We'll verify your OpenVINO install below.
...
error
  ...
  <span class="small">OpenVINO version `2020.1` has been pre-installed.</span>
</div>
