...
<h3 class="step" data-toc-title="Connect a display" id="connect_display">
  <span>1</span>
...
<h3 class="step" data-toc-title="Connect Power" id="connect_power"><span>3</span> Connect the power supply (included).</h3>
