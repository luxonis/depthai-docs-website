...
1.  Download our pre-configured Raspbian image for the BW1097 (the Raspberry Pi Compute Module Edition), here: https://drive.google.com/open?id=19JRcRkdmiJ96lsoMdCu2_zbbYrSG7wsu
...
2.  Set up your own Raspbian to your liking from say a fresh Raspbian download, and then use replace dt-blob.bin and config.txt in /boot with the following two files:
 - https://drive.google.com/open?id=1OarNtX58YUtVcqHog8NnnCWmCgYpN-z_ - For enabling the Pi MIPI display
 - https://drive.google.com/open?id=1cg8OZVFwq6NB1judrsUNV6T7YIcYX1eD - For enabling the 3.5mm headphone jack
